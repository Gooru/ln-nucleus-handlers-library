# Nucleus Handlers Library

Building nucleus-library
========================
...
> java -classpath ./build/libs/nucleus-library-0.1-snapshot-fat.jar: -Dvertx.logger-delegate-factory-class-name=io.vertx.core.logging.SLF4JLogDelegateFactory io.vertx.core.Launcher -conf src/main/resources/nucleus-library.json -cluster -instances 4
