...
public class AJEntityLibraryContent extends Model {
  ...
  public static final List<String> VALID_CONTENT_TYPES = Arrays.asList(CONTENT_TYPE_COURSE,
      CONTENT_TYPE_COLLECTION, CONTENT_TYPE_ASSESSMENT, CONTENT_TYPE_RESOURCE,
      CONTENT_TYPE_QUESTION, CONTENT_TYPE_RUBRIC, CONTENT_TYPE_OFFLINE_ACTIVITY);
  ...
  public static final List<String> LIBRARY_CONTENTS_FIELDS =
      Arrays.asList(ID, CONTENT_ID, CONTENT_TYPE, SEQUENCE_ID);
