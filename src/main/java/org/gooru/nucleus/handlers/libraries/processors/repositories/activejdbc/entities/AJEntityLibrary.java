...
public class AJEntityLibrary extends Model {
  ...
  public static final List<String> LIBRARIES_FIELDS =
      Arrays.asList(ID, NAME, SHORT_NAME, DESCRIPTION, THUMBNAIL, TENANT, TENANT_ROOT, COURSE_COUNT,
          ASSESSMENT_COUNT, COLLECTION_COUNT, RESOURCE_COUNT, QUESTION_COUNT, RUBRIC_COUNT,
          SEQUENCE_ID, TAXONOMY, TASK_COUNT, OFFLINE_ACTIVITY_COUNT);

  public static final List<String> LIBRARY_SUMMARY_FIELDS =
      Arrays.asList(ID, NAME, SHORT_NAME, DESCRIPTION, THUMBNAIL);
}
